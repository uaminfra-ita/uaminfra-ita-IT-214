  ...
  return (
    <>
      ...
      <div className="section-shell">
        ...
        <ResourceSection id="modelos" label="04" title="Modelos para o artigo" description="Escolha o projeto LaTeX organizado, o Elsarticle numérico para início rápido, o pacote oficial completo da Elsevier ou a alternativa editável em Word." resources={resources.workspaceTemplates} />
