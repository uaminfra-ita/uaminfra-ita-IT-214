  ...
  return (
    <section className="page-hero">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-20">
        {eyebrow && <div className="eyebrow border-white/15 bg-white/10 text-cyan-200">{eyebrow}</div>}
        <div className={`${eyebrow ? 'mt-6' : ''} grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end`}>
          <div>
