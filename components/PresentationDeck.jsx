...
export default function PresentationDeck({ title, children, width = '100%', height = '100%', className = '' }) {
  ...
  return (
    <div className={`presentation-shell fixed inset-0 z-[80] ${className}`} ref={shellRef} aria-label={`Apresentação: ${title}`}>
