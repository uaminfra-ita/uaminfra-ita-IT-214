...
O Pages não recebe nem grava uma senha nova. O aluno usa o botão de solicitação para enviar uma notificação ao contato público da disciplina, sem informar senha atual ou nova. A automação encaminha somente nome e identificador opaco. Um instrutor verifica a identidade, confere o pedido no e-mail e executa localmente:
